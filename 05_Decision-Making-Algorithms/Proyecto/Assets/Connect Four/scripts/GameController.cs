...
namespace ConnectFour
{
	public class GameController : MonoBehaviour 
	{
		...
		{
			//Si es el turno del jugador entonces coge la posición del mouse al hacer click
			Vector3 spawnPos = Camera.main.ScreenToWorldPoint(Input.mousePosition);
			
			//Si no es el turno del jugador coge una columna aleatoria donde poner la pieza
			if(!isPlayersTurn)
			{
			...
			GameObject g = Instantiate(
				...
				new Vector3(
					...
					0), // spawn it above the first row
